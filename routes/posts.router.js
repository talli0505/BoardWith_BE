...
router.put("/bookmark/bookmark", authMiddleware, postsController.pushBookmark); // 북마크 등록
router.get("/bookmark/:nickName", authMiddleware, postsController.getBookmark);  //북마크 가져오기
